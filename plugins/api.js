...
export default (ctx, inject) => {
  ...
  const recursos = {
    ...
    sectores: {
      NuevoSector: axiosApi('sectores/NuevoSector'),
      obtiebeSectores: axiosApi('sectores/ObtieneSectores'),
      HistorialSensor: axiosApi('sectores/HistorialSensor'),
      MedidasSectores: axiosApi('sectores/MedidasSectores'),
    },
    sensores: {
      NuevoSensor: axiosApi('Sensores/CreaSensor'),
      ObtieneTipoSensor: axiosApi('Sensores/ObtieneTipoSensor'),
      obtieneSensores: axiosApi('Sensores/obtieneSensores'),
      BajaSensor: axiosApi('Sensores/BajaSensor'),
      HostorialSensor: axiosApi('Sensores/HostorialSensor'),
    },
  }
  inject('api', recursos)
}
